...
config_path = dir_path + \
    '/chinese_simbert_L-12_H-768_A-12/bert_config.json'
checkpoint_path = dir_path + \
    '/chinese_simbert_L-12_H-768_A-12/bert_model.ckpt'
dict_path = dir_path + '/chinese_simbert_L-12_H-768_A-12/vocab.txt'
